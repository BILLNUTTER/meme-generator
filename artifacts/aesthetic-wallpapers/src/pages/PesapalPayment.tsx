...
import { ArrowLeft, Loader2, AlertCircle, CreditCard, MessageCircle, X } from "lucide-react";
          ...
          >
            <div className="flex items-center justify-between px-4 py-3 bg-[#111] border-b border-white/10 shrink-0">
              <div>
                ...
                <p className="text-white/40 text-xs mt-0.5">Enter your M-Pesa number and tap Pay</p>
              </div>
              <button
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8 space-y-5">
            <div>
              ...
              />
              <p className="text-white/30 text-xs mt-2">You'll enter your M-Pesa number on the next screen</p>
            </div>
